NOTE: The Readme.md file is easier to read than this one. (but we've included this because the brief said to)

Our project can be found in its entirety at https://github.com/acf62/Interaction-Design-25

To run this file, open cmd and run "java -jar Interaction_Design_25.jar"
